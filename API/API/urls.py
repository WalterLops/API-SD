...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        description="Descrição da API de Dispositivos",
        terms_of_service="https://www.apisd.com/terms/",
        contact=openapi.Contact(email="contato@apisd.com"),
        license=openapi.License(name="Licença da API de Dispositivos"),
    ),
    public=True,
